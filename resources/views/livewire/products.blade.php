<div>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div class="min-h-screen" x-data="{ sidebarOpen: false }">
            ...
            <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 lg:px-8 py-6 relative">
                <div class="flex justify-between items-center">
                    ...
                    <div class="relative">
                        ...
                        <!-- Filter Dropdown -->
                        <div
                            class="absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-800 shadow-2xl border border-gray-200 dark:border-gray-700 rounded-xl z-50 overflow-hidden"
                            x-show="sidebarOpen"
                        ...
                        >
                            <div class="p-6">
                                ...
                                <!-- Stock Status -->
                                <div class="mb-6">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Stock Status</label>
                                    <select
                            ...
                            @foreach($products as $product)
                                <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl overflow-hidden transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
                                    <div class="relative h-56 bg-gradient-to-br from-indigo-100 via-purple-50 to-indigo-100 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 flex items-center justify-center overflow-hidden">
                                        ...
                                        @if($product->brand)
                                            <div class="absolute top-4 left-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-2 py-1 rounded-full text-xs font-semibold shadow-lg">
                                                {{ $product->brand }}
                                            </div>
                                        @endif
                                    </div>
